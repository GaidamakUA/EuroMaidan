...
public class GetCitiesStrategy extends AbstractProcessResponseStrategy<AbstractGetArrayProtocol.Response> {

    public GetCitiesStrategy(ContentResolver resolver, Message msg) {
